...
import com.example.latihan8.data.SumberData.flavors
    ...
    Scaffold(
        ...
        )
        {
            ...
            composable(route = PengelolaHalaman.Summary.name){
                HalamanDetail(orderUIState = uiState, onCancelButtonClicked = { cancelOrderAndNavigateToRasa(navController) },
                )
            }
        }
    }
